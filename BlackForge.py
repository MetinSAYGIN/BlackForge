...
cmd = f"opt -load-pass-plugin {chosen_so} -passes='module(function(require<optnone>),{chosen_pass}' -S {clair_ll} -o {obf_ll} -disable-verify -debug-pass-manager 2> logs/obf_compil.txt"
